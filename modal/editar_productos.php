		...
		<div class="modal-content">
		  ...
		  <div class="modal-body">
			...
			<div id="resultados_ajax2"></div>
			  ...
			  <div class="form-group">
				<label for="mod_codigo" class="col-sm-3 control-label">Cantidad</label>
				<div class="col-sm-8">
				  <input type="text" class="form-control" id="mod_cantidad" name="mod_cantidad" placeholder="Código del producto" required>
				</div>
			</div>
			  ...
			  <div class="form-group">
				<label for="mod_precio_iva" class="col-sm-3 control-label">Precio IVA</label>
				<div class="col-sm-8">
				  <input type="text" class="form-control" id="mod_precio_iva" name="mod_precio_iva" placeholder="Precio con IVA del producto" required pattern="^[0-9]{1,5}(\.[0-9]{0,2})?$" title="Ingresa sólo números con 0 ó 2 decimales" maxlength="8">
				</div>
			  </div>
