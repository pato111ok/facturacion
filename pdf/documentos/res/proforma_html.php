...
<br><br>
			...
			<tr>
				...
				<td style="width:35%;"><?php echo date("d/m/Y");?></td>
				<td style="width:15%;">Nº Proforma:</td>
				<td style="width:35%;"><?php echo $numero_proforma;?></td>
			</tr>
			<tr>
	...
	while ($row=mysqli_fetch_array($sql))
		...
		?>
			...
			<?php 
				...
				$insert_detail=mysqli_query($con, "INSERT INTO detalle_proforma VALUES ('','$numero_proforma','$id_producto','$cantidad','$precio_venta_r')");
...
$insert=mysqli_query($con,"INSERT INTO proformas VALUES (NULL,'$numero_proforma','$date','$id_cliente','$id_vendedor','$condiciones','$total_factura','1')");
