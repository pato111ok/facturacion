...
<page backtop="15mm" backbottom="15mm" backleft="15mm" backright="15mm" style="font-size: 12pt; font-family: arial" >
        ...
        <table class="page_footer">
            <tr>
                ...
                <!--<td style="width: 50%; text-align: right">
                    &copy; <?php echo "Dielektro "; echo  $anio=date('Y'); ?>
                </td>-->
            </tr>
        </table>
    </page_footer>
    ...
    <table cellspacing="0" style="width: 100%; text-align: left; font-size: 11pt;">
        <tr>
           <td style="width:20%;">Cedula / RUC:</td><!--class='midnight-blue'-->
		   <td style="width:30%;"><?php echo $rw_cliente['cedula_cliente']; ?></td>
		   <td style="width:20%;">Cliente:</td><!--class='midnight-blue'-->
		   <td style="width:30%;"><?php echo $rw_cliente['nombre_cliente']; ?></td>
		   <td style="width:20%;">Dirección:</td><!--class='midnight-blue'-->
		   <td style="width:30%;"><?php echo $rw_cliente['direccion_cliente']; ?></td>
        </tr>
    	</table>
