<?php
	...
	$active_notas_venta="active";
	$active_productos="";
	$active_clientes="";
	$active_usuarios="";	
	$title="Editar Nota Venta ";
	...
	if (isset($_GET['id_factura']))
	{
		...
		$campos="clientes.id_cliente, clientes.nombre_cliente, clientes.telefono_cliente, clientes.email_cliente, notas_venta.id_vendedor, notas_venta.fecha_factura, notas_venta.condiciones, notas_venta.estado_factura, notas_venta.numero_factura";
		$sql_factura=mysqli_query($con,"select $campos from notas_venta, clientes where notas_venta.id_cliente=clientes.id_cliente and id_factura='".$id_factura."'");
				  ...
				  <label for="tel1" class="col-md-1 control-label">Teléfono</label>
					...
					<label for="mail" class="col-md-1 control-label">Email</label>
						...
						<div class="form-group row">
							...
							<div class="col-md-2">
								<input type="text" class="form-control input-sm" id="fecha" name="fecha" value="<?php echo $fecha_factura;?>" ><!--readonly-->
							</div>
