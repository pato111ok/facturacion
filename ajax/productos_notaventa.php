<?php
	...
	if($action == 'ajax'){
		// escaping, additionally removing everything that could be (html/javascript-) code
		 ...
		 $aColumns = array('codigo_producto', 'nombre_producto', 'combo_producto');//Columnas de busqueda
		 $sTable = "products";
		 $sWhere = "";
		if ( $_GET['q'] != "" )
		{
			...
			<div class="table-responsive">
			  <table class="table">
				...
				while ($row=mysqli_fetch_array($query)){
					...
					$precio_venta=$row["precio_iva_producto"];
					...
					<tr>
						...
						<td>
							...
							<input type="hidden" class="form-control" style="text-align:right" id="cantidad_producto<?php echo $id_producto; ?>"  value="<?php echo $cantidad_producto;?>" >
							<input type="hidden" class="form-control" style="text-align:right" id="combo_producto_<?php echo $id_producto; ?>"  value="<?php echo $combo_producto;?>" >
							</div>
						</td>
						<td class='col-xs-1'>
						<div class="pull-right">
