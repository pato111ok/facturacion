...
$insert_tmp=mysqli_query($con, "INSERT INTO detalle_nota_venta (numero_factura, id_producto,cantidad,precio_venta) VALUES ('$numero_factura','$id','$cantidad','$precio_venta')");
...
$sql=mysqli_query($con, "select * from products, detalle_nota_venta where products.id_producto=detalle_nota_venta.id_producto and detalle_nota_venta.id_detalle='".$id_detalle."'");
	while ($row=mysqli_fetch_array($sql))
	{
	...
	/*Eliminar de detalle_nota_venta*/
	$id_detalle=intval($_GET['id']);	
...
<?php
	...
	$sql=mysqli_query($con, "select * from products, notas_venta, detalle_nota_venta where notas_venta.numero_factura=detalle_nota_venta.numero_factura and  notas_venta.id_factura='$id_factura' and products.id_producto=detalle_nota_venta.id_producto");
	while ($row=mysqli_fetch_array($sql))
	{
	...
	$update=mysqli_query($con,"update notas_venta set total_venta='$total_factura' where id_factura='$id_factura'");
?>
<tr>
