<?php
	...
	if($action == 'ajax'){
		...
		if ( $_GET['q'] != "" )
		{
			...
			$sWhere.= ") AND LTRIM(RTRIM(combo_producto)) <> '')";
			
		}else{
			$sWhere.=" WHERE (LTRIM(RTRIM(combo_producto)) <> '')";
		}
			...
			<div class="table-responsive">
			  <table class="table">
				...
				while ($row=mysqli_fetch_array($query)){
						...
						$precio_iva_producto=$row['precio_iva_producto'];
					...
					<input type="hidden" value="<?php echo number_format($precio_iva_producto,2,'.','');?>" id="precio_iva_producto<?php echo $id_producto;?>">
					<tr>
						
						<td><?php echo $codigo_producto; ?></td>
						<td ><a href="#" data-toggle="tooltip" data-placement="top" title="<i class='glyphicon glyphicon-barcode'></i> <?php echo $combo_producto;?><br><i class='glyphicon glyphicon-equalizer'></i> <?php echo $cant_combo_producto;?>"><?php echo $nombre_producto;?></a>
						...
						<td><?php echo $simbolo_moneda;?><span class='pull-right'><?php echo number_format($precio_iva_producto,2);?></span></td>
