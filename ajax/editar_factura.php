<?php
	...
	if (empty($_POST['id_cliente'])) {
		...
		$sql="UPDATE facturas SET id_cliente='".$id_cliente."', id_vendedor='".$id_vendedor."', condiciones='".$condiciones."', fecha_factura='".$fecha_factura."', estado_factura='".$estado_factura."' WHERE id_factura='".$id_factura."'";
