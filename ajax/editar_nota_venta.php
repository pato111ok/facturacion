<?php
	...
	if (empty($_POST['id_cliente'])) {
		...
		$fecha_factura = date('Y-m-d', strtotime($date));

		$estado_factura=intval($_POST['estado_factura']);
		
		$sql="UPDATE notas_venta SET id_cliente='".$id_cliente."', id_vendedor='".$id_vendedor."', condiciones='".$condiciones."', fecha_factura='".$fecha_factura."', estado_factura='".$estado_factura."' WHERE id_factura='".$id_factura."'";
