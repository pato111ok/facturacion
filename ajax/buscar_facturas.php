<?php
	...
	if (isset($_GET['id'])){
		...
		$sql=mysqli_query($con, "select * from products, detalle_factura where products.id_producto=detalle_factura.id_producto and detalle_factura.numero_factura='".$numero_factura."'");
		...
		$update1="UPDATE facturas SET estado_factura = 0 WHERE numero_factura='".$numero_factura."'";
